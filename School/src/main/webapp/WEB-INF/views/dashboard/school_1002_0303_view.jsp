         ...
         <div class="col-sm-12">
             <div class="bg-picture text-center" style="background-image:url('<c:url value="/static/images/big/bg.jpg') "/>">
                 ...
                 <div class="profile-info-name">
                     <img src="<c:url value="${ student.imagePath }${student.imageName}" />" class="thumb-lg img-circle img-thumbnail" alt="profile-image">
                     <h3 class="text-white">${ student.lastName }<span></span> ${ student.firstName }</h3>
                 </div>
             </div>
             <!--/ meta -->
         </div>
                         ...
                         <div class="panel panel-default panel-fill">
                             ...
                             <div class="panel-body"> 
                                 <div class="about-info-p">
                                     ...
                                     <br/>
                                     <p class="text-muted">${ student.firstName }<span></span> ${ student.lastName }</p>
                                 </div>
                                 <div class="about-info-p">
                                     <strong>Khmer Name</strong>
                                     <br/>
                                     <p class="text-muted">${ student.kmLastName }<span></span> ${ student.kmFirstName }</p>
                                 </div>
                                 <div class="about-info-p">
                                     <strong>Mobile</strong>
                                     <br/>
                                     <p class="text-muted">${ student.phone1 }</p>
                                 </div>
                                 <div class="about-info-p">
                                     <strong>Email</strong>
                                     <br/>
                                 ...
                                 <div class="about-info-p m-b-0">
                                     ...
                                     <br/>
                                     <p class="text-muted">${ student.currentAddr }</p>
                                 </div>
                             </div> 
                         </div>
                         <!-- Personal-Information -->
